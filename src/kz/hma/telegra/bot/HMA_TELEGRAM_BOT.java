    ...
    public String doCommand(long chatId, String command) {
        if (command.startsWith("/enter")) {
            ...
            if (param.length > 1) {
                ...
                return "Телеграмм BOT Хасиева Магомеда, ВТиП-302, для его работы используйте команду /enter и введите переменные a b x!";
            }
        }
        return "Телеграмм BOT Хасиева Магомеда, ВТиП-302, для его работы используйте команду /enter введите переменные a b x";
    }
